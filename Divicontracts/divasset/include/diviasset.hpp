...
CONTRACT asset2tokenz : public contract{
	public:
		...
		* Update version.
		*
		* This action updates the version string of this asset2tokenz deployment for 3rd party wallets,
    * marketplaces, etc.
		*
		...
		*
		* This action registers a new new author account. 
		*
		...
		*/
		...
		using regauthor_action = action_wrapper< "regauthor"_n, &asset2tokenz::regauthor >;
		...
		*/
		...
		using authorupdate_action = action_wrapper< "authorupdate"_n, &asset2tokenz::authorupdate >;
		...
		* @param requireclaim is true or false. If set to "false", the newly created asset will be transferred to the owner (but author's RAM will be used until the asset is transferred again). If set to
    ...
    *
		...
		*/
		...
		using create_action = action_wrapper< "create"_n, &asset2tokenz::create >;
    ...
    * account specified in the owner field to claim the asset using the owner's RAM.
		...
		*/
		ACTION createlog( name author, name category, name owner, string idata, string mdata, uint64_t assetid,
                                  bool requireclaim );
		using createlog_action = action_wrapper< "createlog"_n, &asset2tokenz::createlog >;
		...
		*/
		...
		using claim_action = action_wrapper< "claim"_n, &asset2tokenz::claim >;
		...
		*/
		...
		using transfer_action = action_wrapper< "transfer"_n, &asset2tokenz::transfer >;
		...
		*/
		...
		using update_action = action_wrapper< "update"_n, &asset2tokenz::update >;
		...
		*/
		...
		using offer_action = action_wrapper< "offer"_n, &asset2tokenz::offer >;
		...
		*/
		...
		using canceloffer_action = action_wrapper< "canceloffer"_n, &asset2tokenz::canceloffer >;
      ...
      attached fungible and non-fungible assets will be destroyed too.
		...
		*/
		...
		using burn_action = action_wrapper< "burn"_n, &asset2tokenz::burn >;

		/*
		* Delegate assets.
		*
		* This action delegates asset to {{to}} account. This action changes the asset owner by calling the transfer action. It also adds a record in the delegates table to record the asset as borrowed.  This blocks the asset from all owner actions (transfers, offers, burning by borrower).
		*
		* @param owner is current asset owner account.
		...
		*/
		...
		using delegate_action = action_wrapper< "delegate"_n, &asset2tokenz::delegate >;
    ...
    * immediately, and the entry in the delegates table recording the borrowing will be erased.
		...
		*/
		...
		using undelegate_action = action_wrapper< "undelegate"_n, &asset2tokenz::undelegate >;
		...
		*/
		...
		using attach_action = action_wrapper< "attach"_n, &asset2tokenz::attach >;
    ...
    * allowed to execute this action.
		...
		*/
		...
		using detach_t_action = action_wrapper< "detach"_n, &asset2tokenz::detach >;
		...
		*/
		...
		using delegatemore_action = action_wrapper< "delegatemore"_n, &asset2tokenz::delegatemore >;
		...
		*/
		...
		using attachf_t_action = action_wrapper< "attachf"_n, &asset2tokenz::attachf >;
		...
		*/
		...
		using detachf_t_action = action_wrapper< "detachf"_n, &asset2tokenz::detachf >;
    ...
    * 	"100000000.00 WOOD". The amount must specify the exact precision.
		* @param authorctrl is IMPORTANT! If true(1) allows token author (and not just owner) to burnf and transferf. 	Cannot be changed after creation!
		...
		*/
		...
		using createf_action = action_wrapper< "createf"_n, &asset2tokenz::createf >;
		...
		*/
		...
		using updatef_action = action_wrapper< "updatef"_n, &asset2tokenz::updatef >;
		...
		*/
		...
		using issuef_action = action_wrapper< "issuef"_n, &asset2tokenz::issuef >;
		...
		*/
		...
		using transferf_action = action_wrapper< "transferf"_n, &asset2tokenz::transferf >;
		...
		*/
		...
		using offerf_action = action_wrapper< "offerf"_n, &asset2tokenz::offerf >;
		...
		*/
		...
		using cancelofferf_action = action_wrapper< "cancelofferf"_n, &asset2tokenz::cancelofferf >;
		...
		*/
		...
		using claimf_action = action_wrapper< "claimf"_n, &asset2tokenz::claimf >;
    ...
    * specified quantity.
		...
		*/
		...
		using burnf_action = action_wrapper< "burnf"_n, &asset2tokenz::burnf >;
		...
		*/
		...
		using openf_action = action_wrapper< "openf"_n, &asset2tokenz::openf >;
		...
		*/
		...
		using closef_action = action_wrapper< "closef"_n, &asset2tokenz::closef >;
		...
		*/
		...
		using createntt_action = action_wrapper< "createntt"_n, &asset2tokenz::createntt >;
		...
		*/
		...
		using createnttlog_action = action_wrapper< "createnttlog"_n, &asset2tokenz::createnttlog >;
		...
		*/
		...
		using claimntt_action = action_wrapper< "claimntt"_n, &asset2tokenz::claimntt >;		
		...
		*/
		...
		using updatentt_action = action_wrapper< "updatentt"_n, &asset2tokenz::updatentt >;		
		...
		*/
		...
		using burnntt_action = action_wrapper< "burnntt"_n, &asset2tokenz::burnntt >;
