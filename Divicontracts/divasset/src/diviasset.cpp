#include <asset2tokenz.hpp>

ACTION asset2tokenz::updatever( string version ) {

	require_auth( get_self() );
	Configs configs( _self, _self.value );
	configs.set( tokenconfigs{ "asset2tokenz"_n, version }, _self );
}

ACTION asset2tokenz::regauthor( name author, string data, string stemplate, string imgpriority ) {
...
ACTION asset2tokenz::authorupdate( name author, string data, string stemplate, string imgpriority ) {
...
ACTION asset2tokenz::create( name author, name category, name owner, string idata, string mdata, bool requireclaim ) {
...
ACTION asset2tokenz::createlog( name author, name category, name owner, string idata, string mdata, uint64_t assetid, bool requireclaim ) {

	require_auth(get_self());
}

ACTION asset2tokenz::claim( name claimer, std::vector<uint64_t>& assetids ) {
...
ACTION asset2tokenz::transfer( name from, name to, std::vector<uint64_t>& assetids, string memo ) {
...
ACTION asset2tokenz::update( name author, name owner, uint64_t assetid, string mdata ) {
...
ACTION asset2tokenz::offer( name owner, name newowner, std::vector<uint64_t>& assetids, string memo ) {
...
ACTION asset2tokenz::canceloffer( name owner, std::vector<uint64_t>& assetids ) {
...
ACTION asset2tokenz::burn( name owner, std::vector<uint64_t>& assetids, string memo ) {
...
ACTION asset2tokenz::delegate( name owner, name to, std::vector<uint64_t>& assetids, uint64_t period, string memo ) {
...
ACTION asset2tokenz::delegatemore( name owner, uint64_t assetidc, uint64_t period ) {
...
ACTION asset2tokenz::undelegate( name owner, name from, std::vector<uint64_t>& assetids ) {
...
ACTION asset2tokenz::attach( name owner, uint64_t assetidc, std::vector<uint64_t>& assetids ) {
...
ACTION asset2tokenz::detach( name owner, uint64_t assetidc, std::vector<uint64_t>& assetids ) {
...
ACTION asset2tokenz::attachf( name owner, name author, asset quantity, uint64_t assetidc ) {

	attachdeatch( owner, author, quantity, assetidc, true );
}


ACTION asset2tokenz::detachf( name owner, name author, asset quantity, uint64_t assetidc ) {

	attachdeatch( owner, author, quantity, assetidc, false );
}

ACTION asset2tokenz::createf( name author, asset maximum_supply, bool authorctrl, string data ) {
...
ACTION asset2tokenz::updatef( name author, symbol sym, string data ) {
...
ACTION asset2tokenz::issuef( name to, name author, asset quantity, string memo ) {
...
ACTION asset2tokenz::transferf( name from, name to, name author, asset quantity, string memo ) {
...
ACTION asset2tokenz::offerf( name owner, name newowner, name author, asset quantity, string memo ) {
...
ACTION asset2tokenz::cancelofferf( name owner, std::vector<uint64_t>& ftofferids ) {
...
ACTION asset2tokenz::claimf( name claimer, std::vector<uint64_t>& ftofferids ) {
...
ACTION asset2tokenz::burnf( name from, name author, asset quantity, string memo ) {
...
ACTION asset2tokenz::openf( name owner, name author, const symbol& symbol, name ram_payer ) {
...
ACTION asset2tokenz::closef( name owner, name author, const symbol& symbol ) {
...
uint64_t asset2tokenz::getid( bool defer ) {
...
uint64_t asset2tokenz::getFTIndex( name author, symbol symbol ) {
...
void asset2tokenz::attachdeatch( name owner, name author, asset quantity, uint64_t assetidc, bool attach ) {
...
void asset2tokenz::sub_balancef( name owner, name author, asset value ) {
...
void asset2tokenz::add_balancef( name owner, name author, asset value, name ram_payer ) {
...
ACTION asset2tokenz::createntt( name author, name category, name owner, string idata, string mdata, bool requireclaim ) {
...
ACTION asset2tokenz::createnttlog( name author, name category, name owner, string idata, string mdata, uint64_t assetid, bool requireclaim ) {

	require_auth(get_self());
}

ACTION asset2tokenz::updatentt( name author, name owner, uint64_t assetid, string mdata ) {
...
ACTION asset2tokenz::claimntt( name claimer, std::vector<uint64_t>& assetids ) {
...
ACTION asset2tokenz::burnntt( name owner, std::vector<uint64_t>& assetids, string memo ) {
...
void asset2tokenz::sendEvent( name author, name rampayer, name seaction, const std::tuple<Args...> &adata ) {
...
asset asset2tokenz::get_supply( name token_contract_account, name author, symbol_code sym_code ) {
	stats statstable( token_contract_account, author.value );
	return statstable.get( sym_code.raw() ).supply;
}

asset asset2tokenz::get_balance( name token_contract_account, name owner, name author, symbol_code sym_code ) {
	stats statstable( token_contract_account, author.value );
	accounts accountstable( token_contract_account, owner.value );
	return accountstable.get( statstable.get( sym_code.raw() ).id ).balance;
}

EOSIO_DISPATCH( asset2tokenz, ( create )( createlog )( transfer )( burn )( update )
